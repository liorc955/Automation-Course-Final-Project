...
public class BookAPI extends CommonOps {
    ...
    public void test01_verifyBookTitle(){
        ...
        Verifications.verifyNumber(ApiActions.getStatusCode(),200);
    }
    ...
    public void test02_addNewBook(String bookIsbn){
        ...
        Verifications.verifyNumber(ApiActions.getStatusCode(),201);
    ...
    public void test04_deleteAllUserBooks(){
        ...
        Verifications.verifyNumber(ApiActions.getStatusCode(),204);
    }
